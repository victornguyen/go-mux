...
func TestDeleteProduct(t *testing.T) {
	...
	reqNotFound, _ := http.NewRequest("GET", "/product/1", nil)
	responseNotFound := executeRequest(reqNotFound)
	checkResponseCode(t, http.StatusNotFound, responseNotFound.Code)
}
